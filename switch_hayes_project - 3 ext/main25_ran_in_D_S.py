...
class EmailSender:
    ...
    def format_email_template(self, data):
        ...
        line_4 = f"Origin (zip (if/app.)): {bold(data.get('pickup_address', 'n/a'))} "
        line_5 = f"Pick up date/ time: {bold(data.get('pickup_date', 'n/a'))}"
        line_6 = f"Pick Up Hours: {bold(data.get('Pick Up Hours', 'n/a'))}"
        line_7 = f"Dock Hours: {bold(data.get('Dock Hours', 'n/a'))}"

        line_8 = f"Destination (zip (if/app.)): {bold(data.get('drop_address', 'n/a'))}"
        ...
        line_12 = f"Est. Fuel Costs: {bold(data.get('fuel_cost', 'n/a'))}"
        ...
        line_24 = f"Fax: {bold(data.get('fax', 'n/a'))}"
        ...
        <div style="text-align: left;">{line_24}</div>
    ...
    def start_sending_emails(self, smtp_server, smtp_port):
        ...
        while not self.stop_event.is_set():
            ...
            # client 1st pattern 
            # email_subject = f"{emojis} - Price: {bold(data.get('price', 'n/a'))} - Truck type: {bold(data.get('truck_type', 'n/a'))} - Pick up (date.) : {bold(data.get('pickup_date', 'n/a'))} - Pick up (loc.): {bold(data.get('pickup_address', 'n/a'))} - Drop off (loc.): {bold(data.get('drop_address', 'n/a'))} - Miles: {bold(data.get('distance', 'n/a'))} - Weight: {bold(data.get('weight', 'n/a'))} - Ref# : {bold(data.get('ref', 'n/a'))}"

            # client 2nd pattern 
            # email_subject = f"{emojis} - Price: {(data.get('price', 'n/a'))} - Truck type: {(data.get('truck_type', 'n/a'))} - Pick up (date.) : {(data.get('pickup_date', 'n/a'))} - Pick up (loc.): {(data.get('pickup_address', 'n/a'))} - Drop off (loc.): {(data.get('drop_address', 'n/a'))} - Miles: {(data.get('distance', 'n/a'))} - Weight: {(data.get('weight', 'n/a'))} - Ref# : {(data.get('ref', 'n/a'))}"
